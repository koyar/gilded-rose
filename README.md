...
- Once the sell by date has passed, Quality degrades twice as fast - test added
...
- Quality drops to 0 after the concert - test added

We have recently signed a supplier of conjured items. This requires an update to our system:

```
"Conjured" items degrade in Quality twice as fast as normal items - test added
```
